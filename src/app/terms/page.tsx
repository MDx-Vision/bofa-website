      ...
      <section className="pt-32 pb-16 bg-gradient-to-b from-[var(--gray-50)] to-white">
        <div className="container">
          <div className="max-w-3xl">
            <h1 className="headline-xl mb-6 text-[var(--gray-900)]">Terms of Service</h1>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="max-w-3xl prose prose-lg">
            <h2 className="headline-md mb-4 text-[var(--gray-900)]">Agreement to Terms</h2>
            ...
            <h2 className="headline-md mb-4 mt-10 text-[var(--gray-900)]">Use of Website</h2>
            ...
            <h2 className="headline-md mb-4 mt-10 text-[var(--gray-900)]">Services</h2>
            <p className="body-md mb-6 text-[var(--gray-600)]">
            ...
            <h2 className="headline-md mb-4 mt-10 text-[var(--gray-900)]">Intellectual Property</h2>
            <p className="body-md mb-6 text-[var(--gray-600)]">
            ...
            <h2 className="headline-md mb-4 mt-10 text-[var(--gray-900)]">Disclaimer of Warranties</h2>
            <p className="body-md mb-6 text-[var(--gray-600)]">
            ...
            <h2 className="headline-md mb-4 mt-10 text-[var(--gray-900)]">Limitation of Liability</h2>
            <p className="body-md mb-6 text-[var(--gray-600)]">
            ...
            <h2 className="headline-md mb-4 mt-10 text-[var(--gray-900)]">Third-Party Links</h2>
            <p className="body-md mb-6 text-[var(--gray-600)]">
            ...
            <h2 className="headline-md mb-4 mt-10 text-[var(--gray-900)]">Indemnification</h2>
            <p className="body-md mb-6 text-[var(--gray-600)]">
            ...
            <h2 className="headline-md mb-4 mt-10 text-[var(--gray-900)]">Governing Law</h2>
            <p className="body-md mb-6 text-[var(--gray-600)]">
            ...
            <h2 className="headline-md mb-4 mt-10 text-[var(--gray-900)]">Changes to Terms</h2>
            <p className="body-md mb-6 text-[var(--gray-600)]">
            ...
            <h2 className="headline-md mb-4 mt-10 text-[var(--gray-900)]">Contact Us</h2>
            <p className="body-md mb-6 text-[var(--gray-600)]">
