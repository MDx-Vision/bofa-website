      ...
      <section className="pt-32 pb-16 bg-gradient-to-b from-[var(--gray-50)] to-white">
        <div className="container">
          <div className="max-w-3xl">
            <h1 className="headline-xl mb-6 text-[var(--gray-900)]">Privacy Policy</h1>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="max-w-3xl prose prose-lg">
            <h2 className="headline-md mb-4 text-[var(--gray-900)]">Introduction</h2>
            ...
            <h2 className="headline-md mb-4 mt-10 text-[var(--gray-900)]">Information We Collect</h2>
            ...
            <h2 className="headline-md mb-4 mt-10 text-[var(--gray-900)]">How We Use Your Information</h2>
            <p className="body-md mb-4 text-[var(--gray-600)]">
            ...
            <h2 className="headline-md mb-4 mt-10 text-[var(--gray-900)]">Information Sharing</h2>
            <p className="body-md mb-6 text-[var(--gray-600)]">
            ...
            <h2 className="headline-md mb-4 mt-10 text-[var(--gray-900)]">Data Security</h2>
            <p className="body-md mb-6 text-[var(--gray-600)]">
            ...
            <h2 className="headline-md mb-4 mt-10 text-[var(--gray-900)]">Your Rights</h2>
            <p className="body-md mb-6 text-[var(--gray-600)]">
            ...
            <h2 className="headline-md mb-4 mt-10 text-[var(--gray-900)]">Cookies</h2>
            <p className="body-md mb-6 text-[var(--gray-600)]">
            ...
            <h2 className="headline-md mb-4 mt-10 text-[var(--gray-900)]">Changes to This Policy</h2>
            <p className="body-md mb-6 text-[var(--gray-600)]">
